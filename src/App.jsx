...
const SectionTitle = ({ enTitle, jaTitle, className = "" }) => (
  ...
  <div
    className={`relative z-10  max-w-7xl mx-auto mb-32 md:mb-48 ${className}`}
  >
...
const RequirementSection = () => {
  return (
    <>
      <section className="px-20   bg-[#8CC63F] overflow-hidden py-24">
        <SectionTitle className="" enTitle="REQUIREMENT" jaTitle="機能" />
        <div className="flex">
          <div>
...
const TeamCard = ({ title, isActive }) => (
  <div
    className={`p-4 rounded-2xl border-2 border-white text-center cursor-pointer transition-all ${isActive ? "bg-white text-[#8CC63F]" : "text-white"}`}
  >
  ...
  return (
    <div className="bg-[#8CC63F] min-h-screen   pt-4 text-black  selection:bg-[#FF4B4B] selection:text-white">
      ...
      <section className="bg-[#8CC63F] px-6 py-20">
        <h2 className="text-5xl font-black text-white opacity-50 mb-10">
          FOUR TEAMS
          <br />
          仕事内容？
        </h2>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/90 p-8 rounded-3xl shadow-lg">
            <h3 className="text-2xl font-bold text-[#8CC63F] mb-4">
              エンジニア
            </h3>
      ...
      <footer className="bg-[#FF4B4B] text-white py-20 px-6 text-center">
        <h2 className="text-5xl font-black mb-10">
          ENTRY
          <br />
          <span className="text-xl">応募フォーム</span>
        </h2>
